...
<div id="page_content_ajax" class="right_col" role="main">
    <div class="">
        <div class="page-title">
            ...
            <div class="x_title">
                <button id="newDefinitions" class="btn btn-default" type="button">New Definitions</button>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table id="datatablesDefinition" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
<script>
    ...
    $(document).ready(function () {
        $('#datatablesDefinition').dataTable({
            "pageLength": 15,
