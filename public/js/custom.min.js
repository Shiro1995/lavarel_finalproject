    ...
    if ("undefined" != typeof echarts) {
        ...
        if ($("#echart_line").length) {
            ...
            f.setOption({
                ...
                calculable: !0,
                xAxis: [{type: "disease", boundaryGap: !1, data: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]}],
                yAxis: [{type: "value"}],
                series: [{
                    name: "Deal",
                    type: "line",
        ...
        if ($("#echart_bar_horizontal").length) {
            ...
            b.setOption({
                ...
                yAxis: [{type: "disease", data: ["Jan", "Feb", "Mar", "Apr", "May", "Jun"]}],
                series: [{
                    name: "2015",
                    type: "bar",
